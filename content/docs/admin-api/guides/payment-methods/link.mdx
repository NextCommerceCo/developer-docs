...
description: Create Admin API orders paid with Link via Stripe using the redirect payment flow, with support for one-click upsells and subscription items
