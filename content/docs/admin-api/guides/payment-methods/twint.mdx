...
description: Create Admin API orders paid with Twint via NEXT Payments using the redirect payment flow, with support for one-click upsells and subscription items
