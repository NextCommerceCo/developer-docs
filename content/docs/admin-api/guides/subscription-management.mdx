...
<Callout type="info">
To update a bankcard on a subscription, you must use the **[iFrame to tokenize](/docs/admin-api/guides/payment-methods/iframe-payment-form)** the bankcard and use the `card_token` when updating the subscription itself.
