...
Cards must be tokenized before submitting on the Admin API, see [iframe card tokenization](/docs/admin-api/guides/payment-methods/iframe-payment-form) guide.
</Callout>
### Test Cards
...
<Callout type="idea">
Use the test card tokens before you've integrated the [iFrame Card Tokenization](/docs/admin-api/guides/payment-methods/iframe-payment-form) to validate your API requests.
</Callout>
### Test Gateway
