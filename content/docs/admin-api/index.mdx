---
title: Admin API
description: Admin API authentication with OAuth apps and access tokens, API versioning with the X-29next-API-Version header, and rate limits
capability_ids: [admin-api, legacy-identifiers]
