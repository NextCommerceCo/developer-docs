...
description: Build a server-to-server app that creates, matches, refunds, and resolves payment disputes with the Admin API and transaction.created webhooks
capability_ids: [disputes]
sidebar_position: 1
tags:
 - Guide
---
