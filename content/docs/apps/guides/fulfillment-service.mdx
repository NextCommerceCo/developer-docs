...
description: Build a fulfillment service app that accepts fulfillment requests, creates full or partial fulfillments, handles cancellations, and syncs stock
sidebar_position: 2
tags:
 - Guide
---
...
### Example Partial Fulfillment Request
...
```json title="Partial Fulfillment Create Payload" http-method="POST" http-target="https://{store}.29next.store/api/admin/fulfillment-orders/{id}/fulfillments/"
{
  "notify": true,
