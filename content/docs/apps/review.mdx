---
title: Submitting an App for Review
description: Checklist for submitting an app for review and how the review process decides whether it is published to the App store
...
<Link className="button button--primary button--lg" style={{marginBottom : '1em' }} href="https://forms.gle/mBnxAfWMSFsHACQ59">App Review Form</Link>
