...
<Callout type="info" title="Offers Are Coming Soon">
Campaign offers are being added to this API. Until they ship, configure them in the dashboard, see [Concepts → Offers](/docs/campaigns#offers). Authorized domains are configured in your store's Campaign Settings, see [Concepts → Domains](/docs/campaigns#domains).
</Callout>
