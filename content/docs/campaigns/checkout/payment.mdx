...
| Field | Mount point |
|---|---|
| Card number | `id="spreedly-number"` or `data-next-checkout-field="cc-number"` |
| CVV | `id="spreedly-cvv"` or `data-next-checkout-field="cvv"` |
...
The month and year dropdowns are populated automatically on load.
