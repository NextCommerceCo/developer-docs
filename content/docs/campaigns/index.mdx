...
| --- | --- |
| [Getting started](https://cart-sdk.nextcommerce.com/latest/documents/Start_Here_Getting_Started) | Loading the SDK and configuring it |
| [How it works](https://cart-sdk.nextcommerce.com/latest/documents/Start_Here_How_It_Works) | Boot sequence and progressive enhancement |
| [Data attributes](https://cart-sdk.nextcommerce.com/latest/documents/Reference_Data_Attributes) | Every `data-next-*` attribute |
| [JavaScript API](https://cart-sdk.nextcommerce.com/latest/documents/Reference_JavaScript_API) | The `window.next` methods |
| [Analytics events](https://cart-sdk.nextcommerce.com/latest/documents/Reference_Analytics_Events) | Every `dl_*` event and its payload |
| [URL parameters](https://cart-sdk.nextcommerce.com/latest/documents/Reference_URL_Parameters) | Parameters the SDK reads at boot |
| [Window globals](https://cart-sdk.nextcommerce.com/latest/documents/Reference_Window_Globals) | Configuration on `window` |
| [Debugger](https://cart-sdk.nextcommerce.com/latest/documents/Reference_Debugger) | The on-page debug overlay |

Building a specific funnel page:

| Page | What it covers |
| --- | --- |
| [Landing and presell](https://cart-sdk.nextcommerce.com/latest/documents/Building_Pages_Landing_and_Presell) | Selectors, bundles, add to cart |
| [Checkout page](https://cart-sdk.nextcommerce.com/latest/documents/Building_Pages_Checkout_Page) | Form fields, payment, express checkout |
| [Upsell page](https://cart-sdk.nextcommerce.com/latest/documents/Building_Pages_Upsell_Page) | Accept and decline flows |
| [Receipt page](https://cart-sdk.nextcommerce.com/latest/documents/Building_Pages_Receipt_Page) | Order data rendering |
...
- [**Analytics events**](https://cart-sdk.nextcommerce.com/latest/documents/Reference_Analytics_Events) — every `dl_*` event the SDK emits, which ones fire automatically, and what each provider receives
