...
Use [**Agent setup**](/docs/agent-setup) to give Claude Code, Codex, Cursor, or another coding agent a working campaign project from one instruction. To install only the platform skills, use [**Next Commerce AI Skills**](/docs/skills).
</Callout>
