...
description: Overview of the Next Commerce developer platform with starting points for campaigns, storefront themes, the Admin API, and apps
sidebar_position: 0
---
...
<Cards>
  <Card
    ...
    title="Campaigns"
    description="Build campaign funnels and custom checkout experiences with the Campaign Cart SDK or Campaign Cart API."
  />
  <Card
    href="/docs/admin-api"
  ...
  <Card
    href="/docs/skills"
    icon={<div className="size-9 rounded-md flex items-center justify-center bg-yellow-500/15 text-yellow-500"><Sparkles className="size-4" /></div>}
    title="AI Skills"
    description="Pre-built skills that teach Claude Code, Cursor, Codex, and Copilot how to work on your store."
  />
</Cards>

<Callout type="idea" title="Building with AI?">
Install [**Next Commerce AI Skills**](/docs/skills) so your coding agent (Claude Code, Cursor, Codex, Copilot, …) knows the platform — APIs, CLI workflows, and architecture patterns — and can work autonomously on your store. One command: `npx skills add NextCommerceCo/skills`.
</Callout>

<Callout type="info" title="Test without real money">
