...
<Callout type="idea">
We highly recommend using Theme Kit to manage your store theme for the best developer experience from your favorite IDE. [Install Theme Kit](/docs/storefront/themes/theme-kit) — installation, configuration, and every `ntk` command.
</Callout>
