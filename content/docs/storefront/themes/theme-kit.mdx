---
title: Theme Kit
description: Install and configure ntk (Theme Kit), connect it to a store with an API key, and use its checkout, push, pull, watch, and sass commands
...
<Tab value="Push a subset of files">
...
<Tab value="Pull a subset of files">
...
<Callout type="info" title="Verify Changes on the Network Domain">
