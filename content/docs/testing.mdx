...
<Callout type="warn">
Adding the Test Gateway to your default gateway group can affect live order flows. On stores with live traffic, prefer test cards, or target the Test Gateway by ID through the API. See [Test Gateway setup](/docs/admin-api/guides/testing-guide#test-gateway).
</Callout>
...
- Create a test subscription through the [Test Gateway](/docs/admin-api/guides/testing-guide#test-subscriptions) (Test Gateway subscriptions can create renewal orders; test-card subscriptions cannot).
